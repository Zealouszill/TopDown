...
def longestSubSequence(tehSequence):
...
def test_longestSubSequence():
    ...
    # for everyNumber in range(len(sequence)):
    #
    #     print("This is sequence", sequence[everyNumber])
    #     print("This is everyNumber", everyNumber)

    assert longestSubSequence(sequence) == [2, 3, 6, 9]
